...
type Collection struct {
	...
	Uri    string            `protobuf:"bytes,110,opt,name=Uri" json:"Uri,omitempty"`
...
type Item struct {
	...
	Uri      string            `protobuf:"bytes,111,opt,name=Uri" json:"Uri,omitempty"`
...
type Version struct {
	...
	Uri    string            `protobuf:"bytes,112,opt,name=Uri" json:"Uri,omitempty"`
...
type Resource struct {
	...
	Uri          string            `protobuf:"bytes,113,opt,name=Uri" json:"Uri,omitempty"`
...
type Link struct {
	...
	Uri    string            `protobuf:"bytes,114,opt,name=Uri" json:"Uri,omitempty"`
...
type QueryDesc struct {
	...
	Uri           string            `protobuf:"bytes,115,opt,name=Uri" json:"Uri,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
